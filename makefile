...
SECTIONS=abstract.md $(INTRO) $(METHODS) results/results.md discussion/discussion.md discussion/future_work.md conclusion/conclusion.md $(TABS_FIGS)
...
$(MANUSCRIPT): $(SECTIONS) $(FORMAT) $(TABS_FIGS) $(BIB)
	pandoc --citeproc -s -o $@ $(SECTIONS) $(FORMAT)
