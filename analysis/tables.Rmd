...
knitr::kable(m_loo[,c("looic", "p_loo", "elpd_diff", "se_diff")], digits = 1, caption = "Model comparison using Pareto-Smoothed Leave-One-Out Information Criteria, ranked in decending order of predictive performance (top row is best). Lower values of looic indicate better predictive performance.")
...
rownames(binom_comp) = c("binomial: in-sample", "artemis: in-sample",
                    "binomial: out-of-sample", "artemis: out-of-sample")
